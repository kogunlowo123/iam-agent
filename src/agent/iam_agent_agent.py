"""IAM Agent - Main Agent Implementation."""
...
class IamAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "audit_permissions": self.tools.audit_permissions,
            "detect_privilege_escalation": self.tools.detect_privilege_escalation,
            "recommend_least_privilege": self.tools.recommend_least_privilege,
            "review_access": self.tools.review_access,
            "revoke_access": self.tools.revoke_access,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['iam', 'reporting', 'monitoring'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "detect_privilege_escalation": ['detect', 'privilege', 'escalation'],
            "recommend_least_privilege": ['recommend', 'least', 'privilege'],
